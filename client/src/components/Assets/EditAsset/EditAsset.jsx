    ...
    <div className={styles.editForm}>
      {isLoading ? (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            onChange={handleChange}
            value={modifiedAsset.tagNumber}
            id='tagNumber'
          />
          <label>Make</label>
          <input onChange={handleChange} value={modifiedAsset.make} id='make' />
          <label>Model</label>
          <input
            onChange={handleChange}
            value={modifiedAsset.model}
            id='model'
          />
          <label>Serial #</label>
          <input
            onChange={handleChange}
            value={modifiedAsset.serialNumber}
            id='serialNumber'
          />
          <label>Location</label>
          <input
            onChange={handleChange}
            value={modifiedAsset.location}
            id='location'
          />
          <label>Acquisition Date</label>
          <input
            onChange={handleChange}
            value={modifiedAsset.acquisitionDate}
            id='acquisitionDate'
          />
          <label>Acquisition Amount</label>
          <input
            onChange={handleChange}
            value={modifiedAsset.transactionAmount}
            id='transactionAmount'
          />
          <label>Status</label>
          <select
            onChange={handleChange}
            value={modifiedAsset.status}
            id='status'
          >
          ...
          <select
            onChange={handleChange}
            value={modifiedAsset.maintenanceStatus}
          ...
          <select
            onChange={handleChange}
            value={modifiedAsset.minimumAccessLevel}
